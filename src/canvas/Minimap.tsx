  ...
  useLayoutEffect(() => {
    ...
    function paint() {
      ...
      if (dirty) {
        ...
        miniature.querySelectorAll('.floating-border-right, .segment-boundaries, .table-column-controls, .object-handle, .vector-hit, .attachment-guides, .marquee-selection').forEach(node => node.remove())
