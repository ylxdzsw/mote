...
export function ReadDocument({ initial, zoomHost = null, minimap = false, minimapSize = 'proportional', onReady = noop, staticWidgets = false }: {
  ...
  return <HistoryContext value={history}><DocumentCanvas doc={doc!} editable={false} zoomHost={zoomHost}
    minimap={minimap} minimapSize={minimapSize} selectedIds={[]} tool={null} staticWidgets={staticWidgets}
