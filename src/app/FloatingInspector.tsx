...
function LabelControls({ label, targetKind, onAction, onChange }: { label: FloatingLabel; targetKind?: FloatingObject['kind']; onAction: (action: Exclude<keyof CanvasActions, 'insert'>) => void; onChange: (patch: FloatingPatch) => void }) {
